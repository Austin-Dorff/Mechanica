...
public class BlockTreeLeaves extends BlockBase implements net.minecraftforge.common.IShearable {
	...
	public BlockTreeLeaves(EnumLeafType leafType) {
		super(leafType.getRegistryName(), leafType.getUnlocalizedName(), leafType.material, leafType.hardness, leafType.resistance);
	...
	public enum EnumLeafType {
		...
		public Material	material	= Material.LEAVES;
									
		private EnumLeafType(String name) {
			this.name = name;
		}
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(MechanicaBlocks.BLOCKS.get(EnumLeafType.RUBBER.getUnlocalizedName()));
	}
	...
	public IBlockState getStateFromMeta(int meta) {
		return this.getDefaultState().withProperty(CHECK_DECAY, true).withProperty(DECAYABLE, meta == 1 ? true : false);
	}
	
	@Override
	public int getMetaFromState(IBlockState state) {
		return state.getValue(DECAYABLE) == true ? 1 : 0;
	}
